...
if __name__ == "__main__":
    env = CarlaEnvironmentWrapper(1, 84, 84, port=45000, throttle=0.35, control_onput=1, randomization=True, preprocess="origin", render=True)
    img = env.reset()
    while True:
        # print(img.shape)
